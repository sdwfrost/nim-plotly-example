...
var trace_73001 = [{}];
trace_73001[0].x = [1, 2, 3, 4];
trace_73001[0].y = [18, 15, 13, 12];
trace_73001[0].mode = makeNimstrLit("lines+markers");
var data_73097 = [[trace_73001[0]]];
var layout_73098 = [{}];
layout_73098[0].title = makeNimstrLit("Line and Scatter Plot");
Plotly_72009.newPlot("myDiv", data_73097[0], layout_73098[0]);
